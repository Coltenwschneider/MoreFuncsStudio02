...
function sortMinArray(numsArray){
  let sortedArray = []
  while(numsArray.length){
    let min = findMinValue(numsArray);
    sortedArray.push(min);
    numsArray.splice(numsArray.indexOf(min), 1);
  }
  return sortedArray;
}
...
console.log(sortMinArray(nums1));
console.log(sortMinArray(nums2));
console.log(sortMinArray(nums3));